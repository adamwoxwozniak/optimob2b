...
import 'package:optimob2b/shared/widgets/product_item.component.dart';
import 'package:optimob2b/themes/themes.dart';
import 'package:shimmer/shimmer.dart';

class AdminProductsPage extends GetView<ProductsController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        if (controller.isLoading.value) {
        ...
        } else if (controller.products.value.items.isEmpty) {
          return Center(
            child: Column(
          ...
          return ListView.separated(
            ...
            itemCount: controller.products.value.items.length,
          );
        }
      }),
          ...
          children: selectionController.hasSelection()
              ? [
                  ...
                  SpeedDialChild(
                      ...
                      onTap: () {
                        selectionController.selectAll(controller.products.value.items.length);
                      }),
                  SpeedDialChild(
